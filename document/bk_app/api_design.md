...
| ----------------------------------------------------- | ---------------------------------------------------- | -------- | ---- | ---------------------------------------- | ------------ |
| [ユーザ新規作成](#ユーザ新規作成)                     | [/signup](#ユーザ新規作成)                           | POST     | 無   | 新規ユーザ登録                           | 認証         |
| [ユーザログイン](#ユーザログイン)                     | [/signin](#ユーザログイン)                           | POST     | 無   | システムログイン。セッション ID を取得   | 認証         |
| [ユーザログアウト](#ユーザログアウト)                 | [/signout](#ユーザログアウト)                        | POST     | 有   | システムログアウト。セッション ID を破棄 | 認証         |
| [CSRF トークン取得](#CSRFトークン取得)                | [/csrf-token](#CSRFトークン取得)                     | GET      | 有   | csrf トークンの取得                      | 認証         |
| [アカウント情報取得](#アカウント情報取得)             | [/account](#アカウント情報取得)                      | GET      | 有   | ユーザアカウント情報の取得               | 認証         |
| [アカウント情報編集](#アカウント情報編集)             | [/account](#アカウント情報編集)                      | PUT      | 有   | ユーザアカウント情報の編集               | 認証         |
| [グループ情報取得](#グループ情報取得)                 | [/group](#グループ情報取得)                          | GET      | 有   | グループ情報取得                         | グループ管理 |
| [グループ新規作成](#グループ新規作成)                 | [/group](#グループ新規作成)                          | POST     | 有   | グループ新規作成                         | グループ管理 |
| [グループ情報更新](#グループ情報更新)                 | [/group](#グループ情報更新)                          | PUT      | 有   | グループ情報更新                         | グループ管理 |
| [参加済みグループ取得](#参加済みグループ)             | [/group/joined](#参加済みグループ)                   | GET      | 有   | 参加済みグループ取得                     | グループ管理 |
| [グループ承認依頼情報取得](#グループ承認依頼情報取得) | [/group/approval-request](#グループ承認依頼情報取得) | GET      | 有   | グループ承認依頼情報取得                 | グループ管理 |
| [グループ参加承認](#グループ参加承認)                 | [/group/approval-request](#グループ参加承認)         | POST     | 有   | グループ参加承認                         | グループ管理 |
| [グループ変更](#グループ変更)                         | [/group/change](#グループ変更)                       | POST     | 有   | グループ変更                             | グループ管理 |
| [グループ離脱](#グループ離脱)                         | [/group/leave](#グループ離脱)                        | POST     | 有   | グループ離脱                             | グループ管理 |
| [グループ招待](#グループ招待)                         | [/group/invite](#グループ招待)                       | POST     | 有   | グループ招待                             | グループ管理 |
| [タスク一覧取得](#タスク一覧取得)                     | [/task/](#タスク一覧取得)                            | GET      | 有   | タスク一覧取得                           | アプリ       |
| [タスク新規作成](#タスク新規作成)                     | [/task/](#タスク新規作成)                            | POST     | 有   | タスク新規作成                           | アプリ       |
| [タスク更新](#タスク更新)                             | [/task/](#タスク更新)                                | PUT      | 有   | タスク更新                               | アプリ       |
| [タスク削除](#タスク削除)                             | [/task/](#タスク削除)                                | DELETE   | 有   | タスク削除                               | アプリ       |
| [タスクステータス変更](#タスクステータス変更)         | [/task/change/status](#タスクステータス変更)         | PUT      | 有   | タスクステータス変更                     | アプリ       |
| [タスク履歴情報取得](#タスク履歴情報取得)             | [/task/history/{task_id}](#タスク履歴情報取得)       | GET      | 有   | タスク履歴情報取得                       | アプリ       |
| [タスクコメント投稿](#タスクコメント投稿)             | [/task/comment](#タスクコメント投稿)                 | POST     | 有   | タスクコメント投稿                       | アプリ       |
| [タスクステータス情報取得](#タスクステータス情報取得) | [/task/status-info](#タスクステータス情報取得)       | GET      | 有   | タスクステータス情報取得                 | アプリ       |
...
| 項目     | 型     | 概要                                           | 必須 |
| -------- | ------ | ---------------------------------------------- | ---- |
| identify | string | 登録したユーザのユーザ名、またはメールアドレス | ◯    |
...
| □├identify   | int    | 招待するユーザのユーザ名、またはメールアドレス |
...
| group_id   | int     | 作成したグループのグループ ID    |
| group_name | string  | 作成したグループのグループ名     |
| selected   | boolean | 選択中の有無　 0:未選択 1:選択中 |
...
| ---------- | ------ | ---------------------------------------------------------- |
| list       | list   | list                                                       |
| □├identify | string | 招待するユーザの識別情報（ユーザ名、またはメールアドレス） |
